    ...
    <div>
      ...
      <motion.div className="md:w-full lg:w-[80%] mx-auto">
        <div className="grid grid-cols-10 gap-8">
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={bottomVariants} transition={{delay: 1}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
              <img src={parking} className="w-16" />
              <p className="font-medium text-xl capitalize">Parking</p>
            </div>
          </motion.div>
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={topVariants} transition={{delay: 1}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
              <img src={safe} className="w-16" />
              <p className="font-medium text-xl capitalize">safe</p>
            </div>
          </motion.div>
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={bottomVariants} transition={{delay: 1.5}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
              <img src={swim} className="w-16" />
              <p className="font-medium text-xl capitalize">Swimmimg Pool</p>
            </div>
          </motion.div>
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={topVariants} transition={{delay: 2}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
              <img src={spa} className="w-16" />
              <p className="font-medium text-xl capitalize">spa</p>
            </div>
          </motion.div>
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={bottomVariants} transition={{delay: 2.5}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
          ...
          <div className="col-span-10 md:col-span-2">
            <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={topVariants} transition={{delay: 3}} className="flex flex-col gap-5 items-center">
              <img src={wifi} className="w-16" />
              <p className=" capitalize text-xl font-medium">Free wifi</p>
            </motion.div>
          </div>
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={bottomVariants} transition={{delay: 3.5}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
              <img src={breakfast} className="w-16" />
              <p className="font-medium text-xl capitalize">breakfast</p>
            </div>
          </motion.div>
          <motion.div viewport={{once: true, amount: 1}} initial="hidden" whileInView="visible" variants={topVariants} transition={{delay: 4}} className="col-span-10 md:col-span-2">
            <div className="flex flex-col gap-5 items-center">
      ...
      <div
        className={`rounded-tr-[60px] rounded-bl-[60px] mt-32 relative bg-[url('https://a6e8z9v6.stackpathcdn.com/hotale/resort/wp-content/uploads/sites/2/2021/11/bg-roomm.jpg')] bg-center bg-no-repeat h-[600px]`}
      >
        <a
          href="https://www.youtube.com/watch?v=US7bGTUkBfg&t=3s"
          target="_blank"
        >
          <img
            src={play}
            alt=""
            className="absolute top-[40%] left-[45%] h-20 cursor-pointer"
          />
        </a>
      </div>
      <TitlePara
      ...
      <div className=" md:mx-10 md:space-y-10 relative">
        <div className="h-[700px] bg-[#F8F8F8] w-[600px] rounded-r-3xl rounded-l-3xl absolute right-56 top-28 -z-50 hidden lg:block"></div>
        {/* photo one  */}
        <div className=" py-[50px] grid md:grid-cols-12 gap-10 md:gap-20">
          ...
          <motion.div viewport={{once: true, amount: 0.5}} initial="hidden" whileInView="visible" variants={rightVariants} className=" space-y-10 col-span-4 lg:col-span-5">
        ...
        <div className=" py-[50px] md:grid md:grid-cols-12 flex flex-col-reverse gap-10 md:gap-20">
          <motion.div viewport={{once: true, amount: 0.5}} initial="hidden" whileInView="visible" variants={leftVariants} className=" space-y-10 col-span-4 lg:col-span-5">
            <h1 className=" text-[30px] font-[500] tracking-[1px]">
