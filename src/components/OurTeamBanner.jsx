...
const OurTeamBanner = ({openLoginModal,setOpenLoginModal, openSignUpModal,setOpenSignUpModal}) => {
  return (
    <>
          ...
          <div className=" py-8 px-10 space-y-10 hidden lg:block">
            <div className=" flex items-center justify-between">
              ...
              <div className=" flex gap-5">
                <button onClick={()=> setOpenLoginModal(!openLoginModal)} className=" bg-transparent border-r-2 px-4 font-medium">
                  Login
                </button>
                <button onClick={()=> setOpenSignUpModal(!openSignUpModal)} className=" font-medium">Sign Up</button>
              </div>
            </div>
