      ...
      <AboutUsBanner
        ...
        >
          <div className=" text-center text-white h-[300px] lg:mb-10 flex flex-col items-center justify-center space-y-5 md:max-w-[60%] mx-auto">
            <h1 className=" text-[40px] md:text-[70px] font-[400]">Search Room</h1>
          </div>
        </AboutUsBanner>
      </div>
                ...
                <div key={room?.id}>
                  <div className="flex flex-wrap items-center gap-2 md:gap-0 pb-[60px]">
                    <div className="w-full lg:w-[40%]">
                      ...
                      {room?.promo? <div className="bg-red-500 text-white w-auto px-4 py-2 rounded-sm absolute  top-3 right-3"><span>{room?.promo}% OFF</span> </div>: null}
                      </div>
                    </div>
                    ...
                    <div className="w-full lg:w-[60%] ps-0 md:ps-[40px] flex flex-col gap-5 justify-center">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-5 ">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className=" text-[#848484]">{room?.area}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap-reverse gap-4 justify-between">
                          ...
                          <Link to={`/roomsDetails/${room?.id}`} className=" hover-underline-animation_room gap-2">
                          <div className="flex items-center gap-1 w-[100vh] md:w-auto">
                          <button className="uppercase font-[600] tracking-[2px] text-[13px]">book now</button>
                          <IoIosArrowForward />
                        </div>
                          </Link>
                        ...
                        <div>
                          ...
                          <span className="text-base text-[#949494]">/night</span>
                        </div>
                      </div>
                    </div>
                  </div>
